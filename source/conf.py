...
# -*- coding: utf-8 -*-
#
# 3DCityDB documentation build configuration file, created by
...
#
# html_title = '3DCityDB Documentation v4.0.0'
...
htmlhelp_basename = '3dcitydb-docsdoc'
...
man_pages = [
    (master_doc, '3dcitydb-docs', '3DCityDB Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, '3dcitydb-docs', '3DCityDB Documentation',
     author, '3dcitydb-docs', 'One line description of project.',
     'Miscellaneous'),
]
...
rst_epilog = open('variables.txt', 'r').read()
